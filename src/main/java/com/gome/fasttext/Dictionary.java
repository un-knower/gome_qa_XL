package com.gome.fasttext;

import com.gome.fasttext.Args.model_name;
import com.gome.fasttext.io.BufferedLineReader;
import com.gome.fasttext.io.LineReader;
	...
	public int getLine(String[] tokens, List<Integer> words, List<Integer> labels, Random urd) {
		...
		if (tokens != null) {
			...
			/*	for(int ii = 0;ii< words.size();ii++)
				{
					System.out.print("  看看: "+words.get(ii)+"    ");
				}
				System.out.println();*/
				// if (EOS == tokens[i]){
				// break;
