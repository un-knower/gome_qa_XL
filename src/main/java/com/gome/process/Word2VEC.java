...
public class Word2VEC {
	...
	public static void main(String[] args) throws IOException {
		...
		vec2.loadGoogleModel("data/chinese-sg.bin") ;
		...
		float sub1 = vec2.getWordVector(str0)[0] - vec2.getWordVector(str1)[0];
		float sub2 = vec2.getWordVector(str2)[0] - vec2.getWordVector(str3)[0];

		System.out.println(vec2.analogy("德国", "柏林", "日本"));
	}
...
//		System.out.println(wordMap.size());
	...
	public TreeSet<WordEntry> analogy(String word0, String word1, String word2) {
		...
		TreeSet<WordEntry> ts = new TreeSet<WordEntry>(wordEntrys);
//		System.out.println("The Answer" + ts.first().name);
		return ts;
	}
